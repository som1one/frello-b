...
- Выводить данные пользователя (пол, возраст, вес, рост и т.д.)
- Писать приветствия, вступления, пояснения
- Показывать расчёты или промежуточные шаги
- Писать что-либо кроме нормы калорий и дней плана

ПРАВИЛА КАЛОРИЙ:
- У КАЖДОГО приёма пищи ОБЯЗАТЕЛЬНО указывай калории и граммы
- Распределение: Завтрак 25-30%, Обед 35-40%, Ужин 20-25%, Перекусы 10-15%
- Сумма калорий за день = суточная норма (±50 ккал)${calorieTarget}

ПРИМЕР ПРАВИЛЬНОГО ОТВЕТА:
Ваша суточная норма калорий для достижения вашей цели: 1800 ккал.
План на 7 дней:

День 1
Завтрак: Овсяная каша с бананом (450 ккал, 350 г)
Обед: Куриная грудка с гречкой и овощами (630 ккал, 400 г)
Ужин: Творог с ягодами (360 ккал, 250 г)
Полдник: Яблоко с орехами (360 ккал, 150 г)
