...
ТОЛЬКО JSON, без markdown/пояснений/приветствий.`;
  ...
  preparePlan({
    ...
    const planJsonInstruction = `\n\nВерни ТОЛЬКО JSON-массив дней, где каждый день - объект с полем "meals". Каждый "meals" - массив объектов с полями: type, recipeName, calories, portionSize.
...
- ТОЛЬКО JSON, без дополнительного текста, приветствий, markdown или пояснений.`;
