...
- НЕ используй нереалистичные значения (например, 50г порции для обеда, 1000 ккал для перекуса, 400г с 850+ ккал для обычного блюда, или 50 ккал для полноценного завтрака).
