...
4. РЕАЛИСТИЧНОСТЬ ПОРЦИЙ И КАЛОРИЙНОСТИ ПО ПРИЁМАМ ПИЩИ:
   ...
   - Обед: 400-800 ккал (обычно 500-700 ккал), порции 300-450г. Обед может быть более сытным
   - Ужин (особенно при похудении): 300-600 ккал (обычно 400-500 ккал), порции 250-400г. Ужин должен быть ЛЁГКИМ, белково-овощным. НЕ используй тяжёлые калорийные блюда (например, борщ 800 ккал) на ужин при похудении - это ошибка! Супы лучше на обед, не на ужин
...
5. ✓ Порции реалистичны для типа блюда и приёма пищи
6. ✓ Ужин лёгкий (при похудении), обед может быть сытнее
