...
- КРИТИЧЕСКИ ВАЖНО: Каждый день в сумме ДОЛЖЕН давать ровно суточную норму калорий (допустимое отклонение ±30 ккал)
- ОБЯЗАТЕЛЬНО проверяй сумму калорий за каждый день после составления плана. Если сумма не совпадает с нормой - исправь блюда, изменив порции или заменив блюда, чтобы сумма была равна норме
- В конце каждого дня можешь указать итоговую сумму калорий для проверки, например: "Итого: [число] ккал"
